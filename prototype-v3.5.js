...
function rMyAssets(){
  ...
  // Stats row
  if(isGuild){
    h+='<div class="stat-row"><div class="stat-item"><div class="label">机构账户余额</div><div class="value" style="color:var(--primary);">¥24,880.00</div></div><div class="stat-item"><div class="label">待结算金额</div><div class="value" style="color:var(--warning);">¥8,750.00</div></div><div class="stat-item"><div class="label">本月流水</div><div class="value" style="color:var(--success);">¥32,500</div></div><div class="stat-item"><div class="label">累计结算</div><div class="value">¥186,200</div></div></div>'+(currentRole==='guild_admin'?'<div style="margin-bottom:16px;"><button class="ant-btn ant-btn-primary" onclick="openGuildSettle()">🏛️ 申请机构结算</button></div>':'')+'';
  }else if(isBooster){
  ...
  if(curAssetTab==='order'){
    // 订单流水
    h+='<div class="ant-table-wrap"><table class="ant-table"><thead><tr><th>时间</th><th>订单ID</th><th>订单类型</th>'+(isBooster?'':'<th>订单来源</th>')+'<th>结算金额</th><th>入账金额</th>'+(isGuild?'<th>代练</th>':'')+'<th>创建人</th><th>订单备注</th></tr></thead><tbody>';
    var orderFlows;
    if(isGuild){
      orderFlows=[{time:'05-26 14:30',id:'DD202605260015',type:'代练',src:'内部录入',settle:'¥298',income:'¥208',booster:'王代练',creator:'张运营',note:'跑刀 300万哈夫币'},{time:'05-26 11:15',id:'DD202605260013',type:'代练',src:'外部订单',settle:'¥520',income:'¥0',booster:'刘代练',creator:'李客服',note:'装备刷取x3'},{time:'05-25 18:30',id:'DD202605250010',type:'代练',src:'内部录入',settle:'¥650',income:'¥455',booster:'陈代练',creator:'张运营',note:'账号练级1→30'},{time:'05-24 15:20',id:'DD202605240005',type:'陪玩',src:'外部订单',settle:'¥350',income:'¥0',booster:'王代练',creator:'李客服',note:'排位黄金→铂金'},{time:'05-24 09:00',id:'DD202605240003',type:'代练',src:'内部录入',settle:'¥800',income:'¥560',booster:'赵代练',creator:'张运营',note:'排位钻石→黑鹰'},{time:'05-23 16:00',id:'DD202605230008',type:'代练',src:'外部订单',settle:'¥300',income:'¥0',booster:'王代练',creator:'李客服',note:'排位青铜→钻石'}];
    }else if(isBooster){
      orderFlows=[{time:'05-26 14:30',id:'DD202605260015',type:'代练',src:'内部录入',settle:'¥298',income:'¥208',creator:'张运营',note:'跑刀 300万哈夫币'},{time:'05-26 11:15',id:'DD202605260013',type:'代练',src:'外部订单',settle:'¥520',income:'¥364',creator:'李客服',note:'装备刷取x3'},{time:'05-25 18:30',id:'DD202605250010',type:'代练',src:'内部录入',settle:'¥650',income:'¥455',creator:'张运营',note:'账号练级1→30'},{time:'05-24 15:20',id:'DD202605240005',type:'陪玩',src:'外部订单',settle:'¥350',income:'¥245',creator:'李客服',note:'排位黄金→铂金'},{time:'05-23 16:00',id:'DD202605230008',type:'代练',src:'外部订单',settle:'¥300',income:'¥210',creator:'张运营',note:'排位青铜→钻石'}];
    }else{
      orderFlows=[{time:'05-26 14:30',id:'DD202605260015',type:'代练',src:'内部录入',settle:'¥298',income:'¥208',creator:'张运营',note:'跑刀 300万哈夫币'},{time:'05-26 11:15',id:'DD202605260013',type:'代练',src:'外部订单',settle:'¥520',income:'¥364',creator:'李客服',note:'装备刷取x3'},{time:'05-25 18:30',id:'DD202605250010',type:'代练',src:'内部录入',settle:'¥650',income:'¥455',creator:'张运营',note:'账号练级1→30'},{time:'05-24 15:20',id:'DD202605240005',type:'陪玩',src:'外部订单',settle:'¥350',income:'¥245',creator:'李客服',note:'排位黄金→铂金'},{time:'05-23 10:00',id:'DD202605230003',type:'代练',src:'内部录入',settle:'¥200',income:'¥140',creator:'张运营',note:'任务代打周常'}];
    }
    ...
    displayOrderFlows.forEach(function(f){
      h+='<tr><td>'+f.time+'</td><td class="link">'+f.id+'</td><td>'+f.type+'</td>'+(isBooster?'':'<td>'+f.src+'</td>')+'<td style="font-weight:500;">'+f.settle+'</td><td style="color:var(--success);font-weight:500;">'+f.income+'</td>'+(isGuild?'<td>'+(f.booster||'-')+'</td>':'')+'<td>'+f.creator+'</td><td>'+f.note+'</td></tr>';
    });
    h+='</tbody></table></div>';
  }else{
    // 结算流水
...
function rOrderMgmt(){
  ...
  var orders=[
    {id:'DD202605260012',title:'排位青铜→钻石',status:'待审核',st:'ant-tag-default',prog:'-',asset:'-',booster:'-',settle:'¥298',amt:'¥298',dep:'¥0',src:'内部录入',studio:'-',contact:'138****8888',type:'代练',game:'三角洲',zone:'QQ',role:'玩家A',time:'05-26 14:30',guild:'-',creator:'张运营'},
    {id:'DD202605260011',title:'任务代打日常全清',status:'执行中',st:'ant-tag-primary',prog:'6/10',asset:'6M/10M',booster:'王代练',settle:'¥105',amt:'¥150',dep:'¥30',src:'外部订单',studio:'外部',contact:'137****6666',type:'代练',game:'三角洲',zone:'QQ',role:'玩家B',time:'05-26 13:20',guild:'三角洲机构A组',creator:'张运营'},
    {id:'DD202605260010',title:'装备刷取x3',status:'待验收',st:'ant-tag-warning',prog:'2/3',asset:'4M/5M',booster:'刘代练',settle:'¥312',amt:'¥520',dep:'¥100',src:'内部录入',studio:'-',contact:'136****0001',type:'代练',game:'三角洲',zone:'QQ',role:'玩家C',time:'05-26 11:15',guild:'-',creator:'李客服'},
    {id:'DD202605260009',title:'账号练级1→30',status:'待指派',st:'ant-tag-primary',prog:'-',asset:'-',booster:'-',settle:'¥650',amt:'¥650',dep:'¥130',src:'外部订单',studio:'外部',contact:'135****0002',type:'代练',game:'三角洲',zone:'微信',role:'玩家D',time:'05-26 10:00',guild:'-',creator:'李客服'},
    {id:'DD202605250015',title:'排位黄金→铂金',status:'待结算',st:'ant-tag-danger',prog:'100%',asset:'5M',booster:'陈代练',settle:'¥245',amt:'¥350',dep:'¥70',src:'外部订单',studio:'外部',contact:'134****0003',type:'代练',game:'三角洲',zone:'QQ',role:'玩家E',time:'05-25 16:30',guild:'三角洲机构A组',creator:'张运营'},
    {id:'DD202605250010',title:'任务代打周常',status:'待审核',st:'ant-tag-default',prog:'-',asset:'-',booster:'-',settle:'¥120',amt:'¥120',dep:'¥24',src:'内部录入',studio:'-',contact:'133****0004',type:'代练',game:'三角洲',zone:'QQ',role:'玩家F',time:'05-25 14:00',guild:'-',creator:'李客服'},
    {id:'DD202605240020',title:'排位钻石→黑鹰',status:'执行中',st:'ant-tag-primary',prog:'30%',asset:'2M/12M',booster:'赵代练',settle:'¥560',amt:'¥800',dep:'¥160',src:'外部订单',studio:'外部',contact:'131****0005',type:'代练',game:'三角洲',zone:'QQ',role:'玩家G',time:'05-24 09:00',guild:'三角洲机构B组',creator:'张运营'},
    {id:'DD202605240015',title:'装备刷取全套',status:'已关单',st:'ant-tag-default',prog:'-',asset:'-',booster:'-',settle:'-',amt:'¥1,200',dep:'¥0',src:'内部录入',studio:'-',contact:'139****0006',type:'代练',game:'三角洲',zone:'微信',role:'玩家H',time:'05-24 08:00',guild:'-',creator:'李客服'},
    {id:'DD202605230008',title:'排位青铜→钻石',status:'执行中',st:'ant-tag-primary',prog:'80%',asset:'12M/15M',booster:'刘代练',settle:'¥210',amt:'¥300',dep:'¥60',src:'内部录入',studio:'-',contact:'137****0007',type:'代练',game:'三角洲',zone:'QQ',role:'玩家I',time:'05-23 16:00',guild:'-',creator:'张运营'},
    {id:'DD202605220005',title:'账号练级10→50',status:'已完成',st:'ant-tag-success',prog:'100%',asset:'50M',booster:'孙代练',settle:'¥686',amt:'¥980',dep:'¥196',src:'内部录入',studio:'-',contact:'136****0008',type:'代练',game:'三角洲',zone:'QQ',role:'玩家J',time:'05-22 08:30',guild:'三角洲机构B组',creator:'李客服'},
    {id:'DD202605200003',title:'排位白银→黄金',status:'已暂停',st:'ant-tag-danger',prog:'45%',asset:'3M/7M',booster:'赵代练',settle:'-',amt:'¥180',dep:'¥36',src:'外部订单',studio:'外部',contact:'132****0009',type:'代练',game:'三角洲',zone:'微信',role:'玩家K',time:'05-20 15:00',guild:'-',creator:'张运营'}
  ];
  ...
  filtered.forEach(function(r){
    ...
    h+='<tr class="clickable"><td class="sticky-col" style="white-space:nowrap;">'+ops+'</td><td class="link">'+r.id+'</td><td>'+r.title+'</td><td><span class="ant-tag '+r.st+'">'+r.status+'</span></td><td>'+r.booster+'</td><td>'+(r.guild==='-'?'-':'<span class="ant-tag ant-tag-purple">'+r.guild+'</span>')+'</td><td>'+r.time+'</td><td>'+r.creator+'</td><td>'+r.amt+'</td><td>'+r.settle+'</td><td>'+r.src+'</td><td>'+r.contact+'</td><td>'+r.type+'</td><td>'+r.game+'</td><td>'+r.zone+'</td><td>'+r.role+'</td></tr>';
  });
...
function rGuildSettlement(){
  var rows=[
    {guild:'三角洲机构A组',admin:'张会长',tel:'138****1111',amt:'¥8,750.00',status:'待打款',st:'ant-tag-warning',method:'银行卡',settleInfo:'中国工商银行 6212****1234 张会长',channelFee:'¥87.50',monthlyTotal:'¥0.00',taxSupplement:'¥0.00',arrivalAmt:'¥8,662.50'},
    {guild:'三角洲机构B组',admin:'李会长',tel:'139****2222',amt:'¥4,760.00',status:'待打款',st:'ant-tag-warning',method:'支付宝',settleInfo:'支付宝 139****2222 李会长',channelFee:'¥47.60',monthlyTotal:'¥0.00',taxSupplement:'¥0.00',arrivalAmt:'¥4,712.40'},
    {guild:'三角洲机构C组',admin:'王会长',tel:'137****3333',amt:'¥2,730.00',status:'已打款',st:'ant-tag-success',method:'银行卡',settleInfo:'招商银行 6214****9012 王会长',channelFee:'¥27.30',monthlyTotal:'¥0.00',taxSupplement:'¥0.00',arrivalAmt:'¥2,702.70'},
    {guild:'三角洲机构A组',admin:'张会长',tel:'138****1111',amt:'¥12,500.00',status:'已打款',st:'ant-tag-success',method:'银行卡',settleInfo:'中国工商银行 6212****1234 张会长',channelFee:'¥125.00',monthlyTotal:'¥0.00',taxSupplement:'¥0.00',arrivalAmt:'¥12,375.00'},
    {guild:'三角洲机构B组',admin:'李会长',tel:'139****2222',amt:'¥8,200.00',status:'已打款',st:'ant-tag-warning',method:'支付宝',settleInfo:'支付宝 139****2222 李会长',channelFee:'¥82.00',monthlyTotal:'¥0.00',taxSupplement:'¥0.00',arrivalAmt:'¥8,118.00'}
  ];
  ...
  h+='<div class="ant-card"><div class="ant-card-body np"><div class="ant-table-wrap"><table class="ant-table"><thead><tr><th style="width:130px;">操作</th><th>机构名</th><th>管理员信息</th><th>结算状态</th><th>结算方式</th><th>结算信息</th><th>结算金额</th><th>通道费</th><th style="opacity:0.4;">当月累计结算 <span style="font-size:11px;">(二期)</span></th><th style="opacity:0.4;">应补税费 <span style="font-size:11px;">(二期)</span></th><th>到账金额</th></tr></thead><tbody>';
  rows.forEach(function(r){
    ...
    h+='<tr><td>'+action+'</td><td style="font-weight:500;">'+r.guild+'</td><td>'+r.admin+'<br><span style="font-size:var(--font-size-sm);color:var(--text-secondary);">'+r.tel+'</span></td><td><span class="ant-tag '+r.st+'">'+r.status+'</span></td><td>'+r.method+'</td><td>'+r.settleInfo.replace(' ','<br><span style="font-size:var(--font-size-sm);color:var(--text-secondary);">')+'</span></td><td style="font-weight:600;">'+r.amt+'</td><td style="color:var(--text-secondary);">'+r.channelFee+'</td><td style="opacity:0.4;">'+r.monthlyTotal+'</td><td style="opacity:0.4;">'+r.taxSupplement+'</td><td style="color:var(--success);font-weight:600;">'+r.arrivalAmt+'</td></tr>';
  });
  h+='</tbody></table></div></div></div>';
...
function saveNewOrg(){
  ...
  if(!admin) return toast('请选择<span style="color:var(--danger);">机构负责人</span>');
