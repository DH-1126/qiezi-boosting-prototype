...
function rOrderMgmt(){
  ...
  var orders=[
    {id:'DD202605260012',title:'排位青铜→钻石',status:'待审核',st:'ant-tag-default',prog:'-',asset:'-',booster:'-',settle:'¥298',amt:'¥298',dep:'¥0',src:'内部录入',studio:'-',contact:'138****8888',type:'代练',game:'三角洲',zone:'QQ',role:'玩家A',time:'05-26 14:30',guild:'-'},
    {id:'DD202605260011',title:'任务代打日常全清',status:'执行中',st:'ant-tag-primary',prog:'6/10',asset:'6M/10M',booster:'王代练',settle:'¥105',amt:'¥150',dep:'¥30',src:'外部订单',studio:'外部',contact:'137****6666',type:'代练',game:'三角洲',zone:'QQ',role:'玩家B',time:'05-26 13:20',guild:'三角洲机构A组'},
    {id:'DD202605260010',title:'装备刷取x3',status:'待验收',st:'ant-tag-warning',prog:'2/3',asset:'4M/5M',booster:'刘代练',settle:'¥312',amt:'¥520',dep:'¥100',src:'内部录入',studio:'-',contact:'136****0001',type:'代练',game:'三角洲',zone:'QQ',role:'玩家C',time:'05-26 11:15',guild:'-'},
    {id:'DD202605260009',title:'账号练级1→30',status:'待指派',st:'ant-tag-primary',prog:'-',asset:'-',booster:'-',settle:'¥650',amt:'¥650',dep:'¥130',src:'外部订单',studio:'外部',contact:'135****0002',type:'代练',game:'三角洲',zone:'微信',role:'玩家D',time:'05-26 10:00',guild:'-'},
    {id:'DD202605250015',title:'排位黄金→铂金',status:'待结算',st:'ant-tag-danger',prog:'100%',asset:'5M',booster:'陈代练',settle:'¥245',amt:'¥350',dep:'¥70',src:'外部订单',studio:'外部',contact:'134****0003',type:'代练',game:'三角洲',zone:'QQ',role:'玩家E',time:'05-25 16:30',guild:'三角洲机构A组'},
    {id:'DD202605250010',title:'任务代打周常',status:'待审核',st:'ant-tag-default',prog:'-',asset:'-',booster:'-',settle:'¥120',amt:'¥120',dep:'¥24',src:'内部录入',studio:'-',contact:'133****0004',type:'代练',game:'三角洲',zone:'QQ',role:'玩家F',time:'05-25 14:00',guild:'-'},
    {id:'DD202605240020',title:'排位钻石→黑鹰',status:'执行中',st:'ant-tag-primary',prog:'30%',asset:'2M/12M',booster:'赵代练',settle:'¥560',amt:'¥800',dep:'¥160',src:'外部订单',studio:'外部',contact:'131****0005',type:'代练',game:'三角洲',zone:'QQ',role:'玩家G',time:'05-24 09:00',guild:'三角洲机构B组'},
    {id:'DD202605240015',title:'装备刷取全套',status:'已关单',st:'ant-tag-default',prog:'-',asset:'-',booster:'-',settle:'-',amt:'¥1,200',dep:'¥0',src:'内部录入',studio:'-',contact:'139****0006',type:'代练',game:'三角洲',zone:'微信',role:'玩家H',time:'05-24 08:00',guild:'-'},
    {id:'DD202605230008',title:'排位青铜→钻石',status:'执行中',st:'ant-tag-primary',prog:'80%',asset:'12M/15M',booster:'刘代练',settle:'¥210',amt:'¥300',dep:'¥60',src:'内部录入',studio:'-',contact:'137****0007',type:'代练',game:'三角洲',zone:'QQ',role:'玩家I',time:'05-23 16:00',guild:'-'},
    {id:'DD202605220005',title:'账号练级10→50',status:'已完成',st:'ant-tag-success',prog:'100%',asset:'50M',booster:'孙代练',settle:'¥686',amt:'¥980',dep:'¥196',src:'内部录入',studio:'-',contact:'136****0008',type:'代练',game:'三角洲',zone:'QQ',role:'玩家J',time:'05-22 08:30',guild:'三角洲机构B组'},
    {id:'DD202605200003',title:'排位白银→黄金',status:'已暂停',st:'ant-tag-danger',prog:'45%',asset:'3M/7M',booster:'赵代练',settle:'-',amt:'¥180',dep:'¥36',src:'外部订单',studio:'外部',contact:'132****0009',type:'代练',game:'三角洲',zone:'微信',role:'玩家K',time:'05-20 15:00',guild:'-'}
  ];
  ...
  // Table
  h+='<div class="ant-card"><div class="ant-card-body np"><div class="ant-table-wrap"><table class="ant-table"><thead><tr><th class="sticky-col">操作</th><th>订单编号</th><th>订单标题</th><th>订单状态</th><th>当前代练</th><th>所属机构</th><th>创建时间</th><th>价格</th><th>结算</th><th>来源</th><th>联系方式</th><th>类型</th><th>游戏</th><th>区服</th><th>角色</th></tr></thead><tbody>';
