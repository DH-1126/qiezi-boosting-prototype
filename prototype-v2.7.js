...
function rMyAssets(){
  ...
  var flows;
  if(isGuild){
    flows=[{time:'05-26 14:30',type:'订单收入',tag:'ant-tag-primary',order:'DD202605260015',chg:'+¥298',bal:'¥24,880.00',booster:'王代练',note:'跑刀 300万哈夫币'},{time:'05-26 11:15',type:'订单收入',tag:'ant-tag-primary',order:'DD202605260013',chg:'+¥520',bal:'¥24,582.00',booster:'刘代练',note:'装备刷取x3'},{time:'05-25 18:30',type:'订单收入',tag:'ant-tag-primary',order:'DD202605250010',chg:'+¥650',bal:'¥24,062.00',booster:'陈代练',note:'账号练级1→30'},{time:'05-25 10:00',type:'结算打款',tag:'ant-tag-warning',order:'-',chg:'-¥12,500',bal:'¥23,412.00',booster:'-',note:'机构结算打款 05月批次'},{time:'05-24 15:20',type:'订单收入',tag:'ant-tag-primary',order:'DD202605240005',chg:'+¥350',bal:'¥35,912.00',booster:'王代练',note:'排位黄金→铂金'},{time:'05-24 09:00',type:'订单收入',tag:'ant-tag-primary',order:'DD202605240003',chg:'+¥800',bal:'¥35,562.00',booster:'赵代练',note:'排位钻石→黑鹰'},{time:'05-23 16:00',type:'订单收入',tag:'ant-tag-primary',order:'DD202605230008',chg:'+¥300',bal:'¥34,762.00',booster:'王代练',note:'排位青铜→钻石'}];
  }else{
    flows=[{time:'05-26 14:30',type:'订单收入',tag:'ant-tag-primary',order:'DD202605260015',chg:'+¥208',bal:'¥2,500.00',note:'排位上分 青铜→钻石'},{time:'05-26 11:15',type:'订单收入',tag:'ant-tag-primary',order:'DD202605260013',chg:'+¥364',bal:'¥2,292.00',note:'装备刷取x3'},{time:'05-25 18:30',type:'订单收入',tag:'ant-tag-primary',order:'DD202605250010',chg:'+¥455',bal:'¥1,928.00',note:'账号练级1→30'},{time:'05-25 14:00',type:'提现',tag:'ant-tag-warning',order:'-',chg:'-¥3,000',bal:'¥1,473.00',note:'提现到支付宝 138****8888'},{time:'05-24 15:20',type:'订单收入',tag:'ant-tag-primary',order:'DD202605240005',chg:'+¥245',bal:'¥4,473.00',note:'排位黄金→铂金'},{time:'05-23 10:00',type:'提现',tag:'ant-tag-warning',order:'-',chg:'-¥2,000',bal:'¥4,228.00',note:'提现到支付宝 138****8888'},{time:'05-22 16:00',type:'订单收入',tag:'ant-tag-primary',order:'DD202605220008',chg:'+¥210',bal:'¥6,228.00',note:'排位青铜→钻石'},{time:'05-20 12:00',type:'罚扣',tag:'ant-tag-danger',order:'DD202605200005',chg:'-¥100',bal:'¥6,018.00',note:'订单超时罚扣'}];
  }
