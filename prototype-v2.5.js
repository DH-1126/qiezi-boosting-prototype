...
var curPage='home',openGroup='workspace',curTab='全部',curSubTab='按日统计',toastTimer,currentRole='admin',grabCounter=0;
...
function showOrderDetail(oid){
  var body='<div style="display:flex;gap:16px;"><div style="flex:1;"><div class="ant-form-item"><div class="ant-form-label">订单编号</div><div style="font-weight:500;">'+oid+'</div></div><div class="ant-form-item"><div class="ant-form-label">订单状态</div><span class="ant-tag ant-tag-primary">执行中</span></div><div class="ant-form-item"><div class="ant-form-label">订单标题</div><div>排位青铜→钻石</div></div><div class="ant-form-item"><div class="ant-form-label">订单类型</div><div>代练</div></div><div class="ant-form-item"><div class="ant-form-label">游戏信息</div><div>三角洲行动端游 / WeGame / QQ账号</div></div></div><div style="flex:1;"><div class="ant-form-item"><div class="ant-form-label">角色名称</div><div>玩家A</div></div><div class="ant-form-item"><div class="ant-form-label">用户手机号</div><div>138****8888</div></div><div class="ant-form-item"><div class="ant-form-label">订单金额</div><div style="font-weight:500;">¥298.00</div></div><div class="ant-form-item"><div class="ant-form-label">当前代练</div><div>王代练</div></div><div class="ant-form-item"><div class="ant-form-label">指派客服</div><div>小李</div></div></div></div><div class="ant-form-item"><div class="ant-form-label">订单备注</div><div style="color:var(--text-secondary);">客户要求48小时内完成</div></div><div class="ant-form-item"><div class="ant-form-label">创建时间</div><div>2026-05-26 14:30</div></div>';
...
function rMyAssets(){
  ...
  var flows;
  if(isGuild){
    flows=[{time:'05-26 14:30',type:'订单收入',tag:'ant-tag-primary',order:'DD202605260015',chg:'+¥298',bal:'¥24,880.00',note:'排位上分 青铜→钻石'},{time:'05-26 11:15',type:'订单收入',tag:'ant-tag-primary',order:'DD202605260013',chg:'+¥520',bal:'¥24,582.00',note:'装备刷取x3'},{time:'05-25 18:30',type:'订单收入',tag:'ant-tag-primary',order:'DD202605250010',chg:'+¥650',bal:'¥24,062.00',note:'账号练级1→30'},{time:'05-25 10:00',type:'结算打款',tag:'ant-tag-warning',order:'-',chg:'-¥12,500',bal:'¥23,412.00',note:'机构结算打款 05月批次'},{time:'05-24 15:20',type:'订单收入',tag:'ant-tag-primary',order:'DD202605240005',chg:'+¥350',bal:'¥35,912.00',note:'排位黄金→铂金'},{time:'05-24 09:00',type:'订单收入',tag:'ant-tag-primary',order:'DD202605240003',chg:'+¥800',bal:'¥35,562.00',note:'排位钻石→黑鹰'},{time:'05-23 16:00',type:'订单收入',tag:'ant-tag-primary',order:'DD202605230008',chg:'+¥300',bal:'¥34,762.00',note:'排位青铜→钻石'},{time:'05-22 12:00',type:'服务费支出',tag:'ant-tag-default',order:'-',chg:'-¥500',bal:'¥34,462.00',note:'平台服务费月结'}];
  }else{
...
function rGuildSettlement(){
  ...
  var h='<div class="filter-bar"><select class="ant-input" style="width:120px;"><option>结算状态</option><option>待打款</option><option>已打款</option></select><input class="ant-input" style="width:160px;" placeholder="机构名称"><button class="ant-btn ant-btn-primary ant-btn-sm">查询</button><button class="ant-btn ant-btn-sm">重置</button></div>';
